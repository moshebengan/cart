...
const Footer = () => {
  return (
    <footer className="w-full h-auto bg-dark-blue mt-10 pb-5">
      ...
      <div className="container grid grid-cols-1 text-white my-10 md:grid-cols-2 bg-red-700">
        <div className="w-full text-center mb-4 px-5 md:text-left">
        ...
        <div className="w-full flex justify-center items-center gap-6 flex-wrap md:gap-3 bg-yellow-50">
          <Link>About</Link>
          <Link>Blog</Link>
