...
const Footer = () => {
  return (
    <footer className="w-full h-auto bg-dark-blue  pb-5">
      ...
      <div className="container grid grid-cols-1 text-white my-10 md:grid-cols-2">
        <div className="w-full flex flex-col px-10 md:text-left ">
          <h1 className="font-bold text-2xl mb-2">MosesBG-SHOP</h1>
          <p className="mb-4 text-base text-gray-100">
          Quality you can wear, trust you can feel. <br />
          Your fashion, our promise.
          </p>
        </div>
        <div className="w-full flex justify-center items-center gap-6 flex-wrap md:gap-3">
          <Link>About</Link>
          <Link>Blog</Link>
