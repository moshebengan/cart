      ...
      <div className="w-full h-screen flex flex-col overflow-x-hidden">
        <div className="w-full h-[50%] relative">
          <div className="h-full bg-pink-500 flex flex-col">
            ...
            <h4 className="text-gray-400 text-2xl ml-10 mt-10 font-poppins">
        ...
        <div className="relative w-full h-[50%] bg-gray-300 p-4">
        <div className="h-full  bg-yellow-200 flex justify-evenly relative -top-16  ">
