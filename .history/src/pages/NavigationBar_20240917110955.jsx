        ...
        <div className="container">
          <nav className="py-3 flex justify-between items-center text-white">
            ...
            <div className="hidden md:flex gap-6">
              <Link to={"/home"} className="transition hover:scale-110 hover:font-bold">Home</Link>
              <Link to={"/shop"} className="transition hover:scale-110 hover:font-bold">Shop</Link>
              <Link to={"/contact-us"} className="transition hover:scale-110 hover:font-bold">Contact us</Link>
