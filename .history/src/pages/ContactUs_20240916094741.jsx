    ...
    <>
      <div className="w-full h-screen flex flex-col overflow-x-hidden">
        ...
        <div className="h-full  bg-transparent flex justify-evenly relative -top-10  ">
          ...
          <a href={`tel:${+972525833787}`} className="text-blue-400 underline">
            Call me
          </a>
          </div>
          ...
          <a  href={`https://wa.me/${+972525833787}`} target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">
            Chat on WhatsApp
          </a>
          </div>
          </div>
