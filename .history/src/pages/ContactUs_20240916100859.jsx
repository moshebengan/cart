      ...
      <div className="w-full h-screen flex flex-col overflow-x-hidden">
        ...
        <div className="relative w-full h-[40%] bg-white p-4">
          <div className="h-full  bg-transparent flex justify-evenly relative -top-10  ">
            ...
            <div className=" w-1/4 h-full bg-gray-300  flex items-center justify-center rounded-xl drop-shadow-2xl">
              <div className="bg-transparent h-[90%] w-full items-center flex justify-center  flex-col gap-4">
                <MdEmail size={"2em"} />
