...
const HomePage = () => {
  ...
  return (
    <>
      <section className="relative bg-homepage-darker bg-center bg-no-repeat bg-cover font-poppins">
        ...
        <div className="container flex flex-col h-screen justify-center items-start text-white">
          <h1 className="mb-4 font-bold text-4xl lg:text-5xl z-10 ">
            FASHION FADES. STYLE IS ETERNAL.
          </h1>
          <p className="mb-4 text-xl lg:text-2xl z-10">
          Temporary trends may come and go,  <br/>
          But true personal style endures.
          </p>
          <Link to={"/fake-store/shop"}>
            <button className="px-5 py-2.5 font-medium bg-orange-400 rounded-lg transition hover:bg-orange-800 z-10">
              Shop Now!
            </button>
            </Link>
        </div>
