    ...
    <>
      <div className="w-full h-screen flex flex-col overflow-x-hidden">
        ...
        <div className="h-full  bg-transparent flex justify-evenly relative -top-10  ">
          <div className=" ml-10 w-1/4 h-full bg-red-500  flex flex-col items-center j rounded-xl drop-shadow-2xl">
          <div className="bg-yellow-300 h-[90%]">
          <FaPhoneFlip size={"1.4em"}/>
          up
          </div>
