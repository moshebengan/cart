  ...
  return (
    <div className="w-full h-screen flex flex-col">
      ...
      <div className="w-full h-[40%] bg-yellow-200 flex flex-row relative">
        <div className="absolute ml-10 w-3/7 h-full bg-red-500 left-0  -top-20 flex items-center justify-center rounded-xl" >up</div>
        <div className="absolute mr-10 w-3/7 h-full bg-teal-500 right-0 -top-20 flex items-center justify-center rounded-xl">down</div>
