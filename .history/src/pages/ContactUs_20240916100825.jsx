      ...
      <div className="w-full h-screen flex flex-col overflow-x-hidden">
        ...
        <div className="relative w-full h-[40%] bg-white p-4">
          <div className="h-full  bg-transparent flex justify-evenly relative -top-10  ">
            <div className=" w-1/4 h-full bg-gray-300  flex flex-col items-center justify-center rounded-xl drop-shadow-2xl">
              <div className="bg-transparent h-[90%] w-full items-center justify-center flex  flex-col gap-4">
                <FaPhoneAlt size={"2em"} />
                <span>Reach me on my personal phone</span>
                <button className="px-5 py-2.5 font-medium bg-gray-300 rounded-lg transition hover:bg-orange-800 hover:text-white">
                  <a href={`tel:${+972525833787}`}>Call me</a>
                </button>
              </div>
            </div>
            <div className="w-1/4 h-full bg-teal-500 flex flex-col items-center justify-center rounded-xl drop-shadow-2xl">
