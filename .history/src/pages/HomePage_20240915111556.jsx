...
const HomePage = () => {
  ...
  return (
    <>
      <section className="bg-homepage-image bg-center bg-no-repeat bg-cover font-poppins opacity-35">
        <div className="container flex flex-col h-screen justify-center items-start text-dark-blue">
          ...
          <p className="mb-4 text-xl text-gray-100 lg:text-2xl">
            Pick the best way to record everthing! <br/>
            with the best store you trust the most!
          </p>
