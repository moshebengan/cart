...
const ShopPage = () => {
  ...
  return (
    <>
      ...
      <div
        className={`container text-dark-blue ${isFilter ? "block" : "hidden"} animate-fade-in-out transition-all duration-300`}
      >
        <div className="z-[90] fixed top-0 left-0 bottom-0 w-full bg-dark-blue opacity-20"></div>
        <nav className="z-[90] fixed top-0 left-0 bottom-0 flex flex-col gap-10 w-5/6 max-w-sm py-6 px-6 bg-zinc-100 overflow-y-auto">
          <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center ps-4 border border-gray-200 rounded">
              <input
                ...
                checked={filter.filter_category == "men's category"}
            ...
            <div className="flex items-center ps-4 border border-gray-200 rounded">
              <input
                ...
                checked={filter.filter_category == "women's category"}
                onChange={handleInputChange}
                className="w-4 h-4 bg-gray-100 border-gray-300"
              />
              <label
