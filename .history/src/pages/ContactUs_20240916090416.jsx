...
const ContactUs = () => {
  return (
    ...
    <div className="bg-dark-blue w-full h-[50%] relative">
      ...
      <div className="w-full h-[50%] bg-yellow-200 flex flex-row justify-evenly -top-10 ">
        <div className=" ml-10 w-1/4 h-full bg-red-500  flex items-center justify-center rounded-xl " >up</div>
        <div className="mr-10 w-1/4 h-full bg-teal-500  flex items-center justify-center rounded-xl ">down</div>
        <div className="mr-10 w-1/4 h-full bg-orange-500  flex items-center justify-center rounded-xl ">down</div>
